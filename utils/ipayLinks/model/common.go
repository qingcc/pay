...
var (
	MerchantId = "tuling"
	CarrierId  = "tourmind_app"                //发生交易的网站域名或者 APP 名称，需在 iPayLinks 备案成功。商户可 MPS 商户后台申请
	NotifyUrl  = "www.tourmind_app.com/notify" //商户服务器接收 iPayLinks 异步结果的通知地址，可通过 MPS 商户后台配置
	signKey    = "md5SignKey"
